...
### Code Jump
การคลิกรหัสผ้าใน Financial Dashboard เพื่อกระโดดไปที่ Vault โดย pre-fill search ด้วยรหัสนั้น ถ้ารหัสไม่มีในระบบ Vault จะ auto-open ฟอร์มสร้างใหม่ พร้อม code นั้นกรอกไว้แล้ว
