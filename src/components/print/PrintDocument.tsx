  ...
  ({ docType }, ref) => {
    ...
    return (
      <div ref={ref} className="bg-white text-slate-900 font-sans leading-normal text-[12px]">
        ...
        {/* A4 Wrapper */}
        <div className="w-[210mm] min-h-[297mm] px-[10mm] py-[10mm] mx-auto flex flex-col bg-white">
          {/* --- HEADER --- */}
          <header className="flex justify-between items-start border-b-2 border-slate-800 pb-4 mb-4">
          ...
          {/* --- CUSTOMER INFO --- */}
          <section className="mb-5 border border-slate-300 rounded-xl flex overflow-hidden bg-white">
            {/* Left: Customer Info */}
            ...
            <table className="w-full border border-slate-300 border-collapse">
              <thead>
                <tr className="bg-slate-100 text-slate-900 text-xs border-b border-slate-300">
                  ...
                  {showPrices ? (
                    <>
                      <th className="py-2 px-2 w-[110px] text-right font-bold border-r border-slate-300">
                        ราคา/หน่วย
                      </th>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="py-2.5 px-2 align-top border-r border-slate-300">
                            ...
                            {item.notes && (
                              <div className="text-[10px] text-red-500 mt-0.5">* {item.notes}</div>
                            )}
                          </td>
                          ...
                          {showPrices ? (
                            ...
                            <td className="py-2.5 px-2 text-center align-top text-slate-400">-</td>
                          )}
                        </tr>
                      );
                    })}
          ...
          <div className="mt-6 break-inside-avoid page-break-inside-avoid">
            <div className="flex items-start border-t-2 border-slate-800 pt-4 gap-6">
              <div className="flex-1">
                {showPrices && (
            ...
            <div className="grid grid-cols-2 gap-8 mt-10">
              <div className="border border-slate-300 rounded-xl p-4 flex flex-col items-center justify-between min-h-[180px]">
                ...
                <div className="w-full flex flex-col items-center mt-auto">
                  ...
                  <div className="flex gap-1 text-slate-500 text-[11px]">
                    (
