// src/components/workspace/ItemCard.test.tsx
...
describe('ItemCard — actions', () => {
  ...
  it('ปุ่มคัดลอก → ถามยืนยัน → ยืนยัน → duplicateItem (items เพิ่มเป็น 2)', async () => {
    ...
    expect(useNotificationStore.getState().alertConfig.isOpen).toBe(true);
    useNotificationStore.getState().alertConfig.onConfirm();
