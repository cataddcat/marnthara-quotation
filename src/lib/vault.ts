...
export const CATALOG_CATEGORIES: CatalogCategoryDef[] = [
  ...
  { id: FAVORITE_CATEGORIES.ROLLER_BLIND, label: 'ม่านม้วน', costUnit: 'ตร.ล.', vault: 'area' },
  { id: FAVORITE_CATEGORIES.WOODEN_BLIND, label: 'มู่ลี่ไม้', costUnit: 'ตร.ล.', vault: 'area' },
  { id: FAVORITE_CATEGORIES.VERTICAL_BLIND, label: 'ม่านปรับแสง', costUnit: 'ตร.ล.', vault: 'area' },
