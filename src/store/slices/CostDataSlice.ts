...
// ─────────────────────────────────────────────────────────────────────────────
// ค่าแรงมาตรฐานตลาดไทย — ปีของชุดค่า = COST_DATA_YEAR (constants.ts)
...
// ─────────────────────────────────────────────────────────────────────────────
// ราคารางมาตรฐาน (ปี = COST_DATA_YEAR) — legacy fallback (ใช้เมื่อม่านไม่ได้เลือก SKU รางจากคลังวัสดุ)
